...
enum class ErrCode : uint8_t {
  ...
  ConstExprRequired = 0x49,  /// Should be constant expression
  DupExportName = 0x4A,      /// Export name conflicted
  ImmutableGlobal = 0x4B,    /// Tried to store to const global value
  MultiTables = 0x4C,        /// #Tables > 1
  MultiMemories = 0x4D,      /// #Memories > 1
  ...
  ValidationFailed = 0x5F,   /// Validation checking failed
  /// Instantiation phase
